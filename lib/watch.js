(function() {
  ...
  file = function(fileName, callback) {
    return new Watcher(function() {
      ...
      findLastChanged.kept(__bind(function(actualLastChanged) {
        if (this.lastChanged !== false && actualLastChanged > this.lastChanged) {
          callback();
        }
        if (actualLastChanged > this.lastChanged || this.lastChanged === false) {
          return this.lastChanged = actualLastChanged;
        }
      }, this));
